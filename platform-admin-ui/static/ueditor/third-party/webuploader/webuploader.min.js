/* WebUploader 0.1.2 */!(function (a, b) {
  var c, d = {}, e = function (a, b) {
      var c, d, e; if (typeof a === 'string') {
        return h(a)
      } for (c = [], d = a.length, e = 0; d > e; e++) {
        c.push(h(a[e]))
      } return b.apply(null, c)
    }, f = function (a, b, c) {
      arguments.length === 2 && (c = b, b = null), e(b || [], function () {
        g(a, c, arguments)
      })
    }, g = function (a, b, c) {
      var f, g = {exports: b}; typeof b === 'function' && (c.length || (c = [e, g.exports, g]), f = b.apply(null, c), void 0 !== f && (g.exports = f)), d[a] = g.exports
    }, h = function (b) {
      var c = d[b] || a[b]; if (!c) {
    ...
    }, j = b(a, f, e); i(j), typeof module === 'object' && typeof module.exports === 'object' ? module.exports = j : typeof define === 'function' && define.amd ? define([], j) : (c = a.WebUploader, a.WebUploader = j, a.WebUploader.noConflict = function () {
      a.WebUploader = c
    })
}(this, function (a, b, c) {
  return b('dollar-third', [], function () {
  ...
  } var g = function () {}, h = Function.call; return {version: '0.1.2',
    $: b,
    Deferred: c.Deferred,
    ...
    os: (function (a) {
      var b = {}, c = a.match(/(?:Android);?[\s\/]+([\d.]+)?/), d = a.match(/(?:iPad|iPod|iPhone).*OS\s([\d_]+)/); return c && (b.android = parseFloat(c[1])), d && (b.ios = parseFloat(d[1].replace(/_/g, '.'))), b
    }(navigator.userAgent)),
    inherits: function (a, c, d) {
      var e; return typeof c === 'function' ? (e = c, c = null) : e = c && c.hasOwnProperty('constructor') ? c.constructor : function () {
    ...
    var e, f = this; return b ? (e = this._events || (this._events = []), c(a, b, function (a, b) {
  ...
  }), d.extend(c.prototype, {state: 'pending',
    _init: function (a) {
  ...
  function c (b) {
    this.options = d.extend({container: document.body}, b), this.uid = a.guid('rt_')
      ...
      var a, b, c = this.options; return this._container ? this._container : (a = d(c.container || document.body), b = d(document.createElement('div')), b.attr('id', 'rt_' + this.uid), b.css({position: 'absolute', top: '0px', left: '0px', width: '1px', height: '1px', overflow: 'hidden'}), a.append(b), a.addClass('webuploader-container'), this._container = b, b)
    },
      init: a.noop,
      exec: a.noop,
      destroy: function () {
  ...
  function d (b, d) {
    var f, g = a.Deferred(); this.uid = a.guid('client_'), this.runtimeReady = function (a) {
      return g.done(a)
    }, this.connectRuntime = function (b, h) {
      if (f) {
        throw new Error('already connected!')
      } return g.done(h), typeof b === 'string' && e.get(b) && (f = e.get(b)), f = f || e.get(null, d), f ? (a.$.extend(f.options, b), f.__promise.then(g.resolve), f.__client++) : (f = c.create(b, b.runtimeOrder), f.__promise = g.promise(), f.once('ready', g.resolve), f.init(), e.add(f), f.__client = 1), d && (f.__standalone = d), f
  ...
  } var e = a.$; return d.options = {accept: null, disableGlobalDnd: !1}, a.inherits(c, {constructor: d,
    init: function () {
  ...
  function c (a) {
    if (!a) {
      return !1
    } var b = a.length, c = e.type(a); return a.nodeType === 1 && b ? !0 : c === 'array' || c !== 'function' && c !== 'string' && (b === 0 || typeof b === 'number' && b > 0 && b - 1 in a)
  } function d (a) {
    this.owner = a, this.options = a.options
  } var e = a.$, f = b.prototype._init, g = {}, h = []; return e.extend(d.prototype, {init: a.noop,
    invoke: function (a, b) {
    ...
    request: function () {
      ...
      var a = this, b = a._widgets = []; return e.each(h, function (c, d) {
        b.push(new d(a))
      }), f.apply(a, arguments)
    },
      request: function (b, d, e) {
        var f, h, i, j, k = 0, l = this._widgets, m = l.length, n = [], o = []; for (d = c(d) ? d : [d]; m > k; k++) {
        ...
        var b = a.Deferred(), c = arguments; return setTimeout(function () {
        b.resolve.apply(b, c)
      }, 1), b.promise()
      })[j](e || a.noop)) : n[0]
      }}), b.register = d.register = function (b, c) {
       var f, g = {init: 'init'}; return arguments.length === 1 ? (c = b, c.responseMap = g) : c.responseMap = e.extend(g, b), f = a.inherits(d, c), h.push(f), f
     }, d
}), b('widgets/filednd', ['base', 'uploader', 'lib/dnd', 'widgets/widget'], function (a, b, c) {
  var d = a.$; return b.options.dnd = '', b.register({init: function (b) {
    if (b.dnd && this.request('predict-runtime-type') === 'html5') {
      var e, f = this, g = a.Deferred(), h = d.extend({}, {disableGlobalDnd: b.disableGlobalDnd, container: b.dnd, accept: b.accept}); return e = new c(h), e.once('ready', g.resolve), e.on('drop', function (a) {
  ...
  } var e = a.$; return a.inherits(c, {constructor: d,
    init: function () {
      var a = this; a.connectRuntime(a.options, function () {
        a.exec('init'), a.trigger('ready')
      })
  ...
  var d = a.$; return b.register({init: function (b) {
    if (b.paste && this.request('predict-runtime-type') === 'html5') {
      var e, f = this, g = a.Deferred(), h = d.extend({}, {container: b.paste, accept: b.accept}); return e = new c(h), e.once('ready', g.resolve), e.on('paste', function (a) {
  ...
  } return a.inherits(b, {constructor: c,
    slice: function (a, b) {
  ...
  function c (a, c) {
    var f; b.apply(this, arguments), this.name = c.name || 'untitled' + d++, f = e.exec(c.name) ? RegExp.$1.toLowerCase() : '', !f && this.type && (f = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(this.type) ? RegExp.$1.toLowerCase() : '', this.name += '.' + f), !this.type && ~'jpg,jpeg,png,gif,bmp'.indexOf(f) && (this.type = 'image/' + (f === 'jpg' ? 'jpeg' : f)), this.ext = f, this.lastModifiedDate = c.lastModifiedDate || (new Date()).toLocaleString()
  ...
  function e (a) {
  ...
  } var f = b.$; return e.options = {button: null, container: null, label: null, innerHTML: null, multiple: !0, accept: null, name: 'file'}, b.inherits(c, {constructor: e,
    init: function () {
      var b = this, c = b.options, e = c.button; e.addClass('webuploader-pick'), b.on('all', function (a) {
        var g; switch (a) {
    ...
    refresh: function () {
      var a = this.getRuntime().getContainer(), b = this.options.button, c = b.outerWidth ? b.outerWidth() : b.width(), d = b.outerHeight ? b.outerHeight() : b.height(), e = b.offset(); c && d && a.css({bottom: 'auto', right: 'auto', width: c + 'px', height: d + 'px'}).offset(e)
    },
    enable: function () {
  ...
  var d = a.$; return d.extend(b.options, {pick: null, accept: null}), b.register({'add-btn': 'addButton', refresh: 'refresh', disable: 'disable', enable: 'enable'}, {init: function (a) {
    ...
    addButton: function (b) {
      var e, f, g, h = this, i = h.options, j = i.accept; if (b) {
  ...
  function d (a) {
  ...
  } var e = a.$; return d.options = {quality: 90, crop: !1, preserveHeaders: !0, allowMagnify: !0}, a.inherits(b, {constructor: d,
    info: function (a) {
    ...
    loadFromBlob: function (a) {
      var b = this, c = a.getRuid(); this.connectRuntime(c, function () {
  ...
  var d, e = a.$; return d = (function (a) {
    ...
    compressImage: function (b) {
      var d, f, g = this.options.compress || this.options.resize, h = g && g.compressSize || 307200; return b = this.request('get-file', b), !g || !~'image/jpeg,image/jpg'.indexOf(b.type) || b.size < h || b._compressed ? void 0 : (g = e.extend({}, g), f = a.Deferred(), d = new c(g), f.always(function () {
        d.destroy(), d = null
  ...
  function c () {
    ...
    var c = i[this.id]; typeof b !== 'undefined' && (this.statusText = b), a !== c && (i[this.id] = a, this.trigger('statuschange', a, c))
  },
    getStatus: function () {
      return i[this.id]
    },
  ...
  function d () {
  ...
  } var e = a.$, f = c.Status; return e.extend(d.prototype, {append: function (a) {
    ...
    getFile: function (a) {
      return typeof a !== 'string' ? a : this._map[a]
    },
    fetch: function (a) {
      var b, c, d = this._queue.length; for (a = a || f.QUEUED, b = 0; d > b; b++) {
    ...
    sort: function (a) {
      typeof a === 'function' && this._queue.sort(a)
    },
    getFiles: function () {
    ...
    _fileAdded: function (a) {
      var b = this, c = this._map[a.id]; c || (this._map[a.id] = a, a.on('statuschange', function (a, c) {
        b._onFileStatusChange(a, c)
      })), a.setStatus(f.QUEUED)
    },
    _onFileStatusChange: function (a, b) {
      var c = this.stats; switch (b) {
  ...
  var g = a.$, h = /\.\w+$/, i = d.Status; return b.register({'sort-files': 'sortFiles', 'add-file': 'addFiles', 'get-file': 'getFile', 'fetch-file': 'fetchFile', 'get-stats': 'getStats', 'get-files': 'getFiles', 'remove-file': 'removeFile', retry: 'retry', reset: 'reset', 'accept-file': 'acceptFile'}, {init: function (b) {
    var d, e, h, i, j, k, l, m = this; if (g.isPlainObject(b.accept) && (b.accept = [b.accept]), b.accept) {
    ...
    } return m.queue = new c(), m.stats = m.queue.stats, this.request('predict-runtime-type') === 'html5' ? (d = a.Deferred(), l = new f('Placeholder'), l.connectRuntime({runtimeOrder: 'html5'}, function () {
  ...
  return a.support = function () {
    ...
    predictRuntmeType: function () {
      var a, c, d = this.options.runtimeOrder || b.orders, e = this.type; if (!e) {
  ...
  function d (a) {
    ...
    var d = this, e = d.options; d.getRuid() && d.disconnectRuntime(), d.connectRuntime(b.ruid, function () {
      d.exec('init')
    }), d._blob = b, e.fileVal = a || e.fileVal, e.filename = c || e.filename
  },
    append: function (a, b) {
      typeof a === 'object' ? e.extend(this._formData, a) : this._formData[a] = b
    },
    setRequestHeader: function (a, b) {
      typeof a === 'object' ? e.extend(this._headers, a) : this._headers[a] = b
    },
    send: function (a) {
    ...
    _timeout: function () {
      var a = this, b = a.options.timeout; b && (clearTimeout(a._timer), a._timer = setTimeout(function () {
  ...
  function e (a, b) {
    ...
    } return a.blocks = d.concat(), a.remaning = d.length, {file: a,
      has: function () {
        return !!d.length
      },
      fetch: function () {
  ...
  } var f = a.$, g = a.isPromise, h = c.Status; f.extend(b.options, {prepareNextFile: !1, chunked: !1, chunkSize: 5242880, chunkRetry: 2, threads: 3, formData: null}), b.register({'start-upload': 'start', 'stop-upload': 'stop', 'skip-file': 'skipFile', 'is-in-progress': 'isInProgress'}, {init: function () {
    ...
    _tick: function () {
      var b, c, d = this, e = d.options; return d._promise ? d._promise.always(d.__tick) : void (d.pool.length < e.threads && (c = d._nextBlock()) ? (d._trigged = !1, b = function (b) {
    ...
    _nextBlock: function () {
      var a, b, c = this, d = c._act, f = c.options; return d && d.has() && d.file.getStatus() === h.PROGRESS ? (f.prepareNextFile && !c.pending.length && c._prepareNextFile(), d.fetch()) : c.runing ? (!c.pending.length && c.getStats().numOfQueue && c._prepareNextFile(), a = c.pending.shift(), b = function (a) {
        return a ? (d = e(a, f.chunked ? f.chunkSize : 0), c._act = d, d.fetch()) : null
      }, g(a) ? a[a.pipe ? 'pipe' : 'then'](b) : b(a)) : void 0
    },
    _prepareNextFile: function () {
      var a, b = this, c = b.request('fetch-file'), d = b.pending; c && (a = b.request('before-send-file', c, function () {
    ...
    _startSend: function (b) {
      var c, d = this, e = b.file; d.pool.push(b), d.remaning++, b.blob = b.chunks === 1 ? e.source : e.source.slice(b.start, b.end), c = d.request('before-send', b, function () {
        e.getStatus() === h.PROGRESS ? d._doSend(b) : (d._popBlock(b), a.nextTick(d.__tick))
      }), c.fail(function () {
        e.remaning === 1 ? d._finishFile(e).always(function () {
    ...
    _doSend: function (b) {
      var c, e, g = this, i = g.owner, j = g.options, k = b.file, l = new d(j), m = f.extend({}, j.formData), n = f.extend({}, j.headers); b.transport = l, l.on('destroy', function () {
        delete b.transport, g._popBlock(b), a.nextTick(g.__tick)
      }), l.on('progress', function (a) {
        var c = 0, d = 0; c = b.percentage = a, b.chunks > 1 && (f.each(k.blocks, function (a, b) {
       ...
       b.retried = b.retried || 0, b.chunks > 1 && ~'http,abort'.indexOf(a) && b.retried < j.chunkRetry ? (b.retried++, l.send()) : (d || a !== 'server' || (a = c(a)), k.setStatus(h.ERROR, a), i.trigger('uploadError', k, a), i.trigger('uploadComplete', k))
     }), l.on('load', function () {
    var a; return (a = c()) ? void l.trigger('error', a, !0) : void (k.remaning === 1 ? g._finishFile(k, e) : l.destroy())
  ...
  var d, e = a.$, f = {}; return d = {addValidator: function (a, b) {
    f[a] = b
  },
    removeValidator: function (a) {
      ...
      var a = this, b = a.options, c = 0, d = b.fileNumLimit >> 0, e = !0; d && (a.on('beforeFileQueued', function (a) {
    ...
    c = 0
      ...
      var a = this, b = a.options, c = 0, d = b.fileSizeLimit >> 0, e = !0; d && (a.on('beforeFileQueued', function (a) {
    ...
    c = 0
      ...
      var a = this, b = a.options, d = b.fileSingleSizeLimit; d && a.on('beforeFileQueued', function (a) {
  ...
  } var b = this, c = b.options, d = {}; c.duplicate || (b.on('beforeFileQueued', function (b) {
  ...
  function e () {
    var a = {}, d = this, e = this.destory; c.apply(d, arguments), d.type = f, d.exec = function (c, e) {
      var f, h = this, i = h.uid, j = b.slice(arguments, 2); return g[c] && (f = a[i] = a[i] || new g[c](h, d), f[e]) ? f[e].apply(f, j) : void 0
    }, d.destory = function () {
      return e && e.apply(this, arguments)
    }
  } var f = 'html5', g = {}; return b.inherits(c, {constructor: e,
    init: function () {
  ...
  return a.register('Blob', {slice: function (a, c) {
    var d = this.owner.source, e = d.slice || d.webkitSlice || d.mozSlice; return d = e.call(d, a, c), new b(this.getRuid(), d)
  }})
  ...
  var d = a.$, e = 'webuploader-dnd-'; return b.register('DragAndDrop', {init: function () {
    ...
    _dragLeaveHandler: function () {
      var a, b = this; return a = function () {
    ...
    _dropHandler: function (a) {
      var b = this, f = b.getRuid(), g = b.elem.parent().get(0); return g && !d.contains(g, a.currentTarget) ? !1 : (b._getTansferFiles(a, function (a) {
    ...
    _getTansferFiles: function (b, c) {
      var d, e, f, g, h, i, j, k, l = [], m = []; for (b = b.originalEvent || b, f = b.dataTransfer, d = f.items, e = f.files, k = !(!d || !d[0].webkitGetAsEntry), i = 0, j = e.length; j > i; i++) {
    ...
    _traverseDirectoryTree: function (b, c) {
      var d = a.Deferred(), e = this; return b.isFile ? b.file(function (a) {
        c.push(a), d.resolve()
      }) : b.isDirectory && b.createReader().readEntries(function (b) {
        var f, g = b.length, h = [], i = []; for (f = 0; g > f; f++) {
    ...
    destroy: function () {
      var a = this.elem; a.off('dragenter', this.dragEnterHandler), a.off('dragover', this.dragEnterHandler), a.off('dragleave', this.dragLeaveHandler), a.off('drop', this.dropHandler), this.options.disableGlobalDnd && (d(document).off('dragover', this.dragOverHandler), d(document).off('drop', this.dropHandler))
    }})
  ...
  return b.register('FilePaste', {init: function () {
    ...
    _pasteHander: function (a) {
      var b, d, e, f, g, h = [], i = this.getRuid(); for (a = a.originalEvent || a, b = a.clipboardData.items, f = 0, g = b.length; g > f; f++) {
        d = b[f], d.kind === 'file' && (e = d.getAsFile()) && h.push(new c(i, e))
  ...
  var c = a.$; return b.register('FilePicker', {init: function () {
    var a, b, d, e, f = this.getRuntime().getContainer(), g = this, h = g.owner, i = g.options, j = c(document.createElement('label')), k = c(document.createElement('input')); if (k.attr('type', 'file'), k.attr('name', i.name), k.addClass('webuploader-element-invisible'), j.on('click', function () {
      k.trigger('click')
      ...
      var b, d = arguments.callee; g.files = a.target.files, b = this.cloneNode(!0), this.parentNode.replaceChild(b, this), k.off(), k = c(b).on('change', d).on('mouseenter mouseleave', e), h.trigger('change')
  ...
  var c = a.createObjectURL && a || a.URL && URL.revokeObjectURL && URL || a.webkitURL, d = b.noop, e = d; return c && (d = function () {
    ...
    dataURL2Blob: function (a) {
      var b, c, d, e, f, g; for (g = a.split(','), b = ~g[0].indexOf('base64') ? atob(g[1]) : decodeURIComponent(g[1]), d = new ArrayBuffer(b.length), c = new Uint8Array(d), e = 0; e < b.length; e++) {
        c[e] = b.charCodeAt(e)
      } return f = g[0].split(':')[1].split(';')[0], this.arrayBufferToBlob(d, f)
    },
    dataURL2ArrayBuffer: function (a) {
      var b, c, d, e; for (e = a.split(','), b = ~e[0].indexOf('base64') ? atob(e[1]) : decodeURIComponent(e[1]), c = new Uint8Array(b.length), d = 0; d < b.length; d++) {
        c[d] = b.charCodeAt(d)
      } return c.buffer
    },
  ...
  var b; return b = {parsers: {65505: []},
    ...
    parse: function (a, b) {
      var c = this, d = new FileReader(); d.onload = function () {
    ...
    _parse: function (a, c) {
      if (!(a.byteLength < 6)) {
        var d, e, f, g, h = new DataView(a), i = 2, j = h.byteLength - 4, k = i, l = {}; if (h.getUint16(0) === 65496) {
          for (;j > i && (d = h.getUint16(i), d >= 65504 && d <= 65519 || d === 65534) && (e = h.getUint16(i + 2) + 2, !(i + e > h.byteLength));) {
  ...
  var c = {}; return c.ExifMap = function () {
    ...
    size: 1},
    2: {getValue: function (a, b) {
      return String.fromCharCode(a.getUint8(b))
    },
      size: 1,
      ascii: !0},
    3: {getValue: function (a, b, c) {
  ...
  for (m = '', l = 0; l < k.length && (n = k[l], n !== '\x00'); l += 1) {
    m += n
  } return m
} return k
    ...
    this.parseExifTag(b, c, d + 2 + 12 * i, e, f)
      ...
      var g, h, i = d + 10; if (b.getUint32(d + 4) === 1165519206) {
      if (i + 8 > b.byteLength) {
      return void a.log('Invalid Exif data: Invalid segment size.')
    } if (b.getUint16(d + 8) !== 0) {
  ...
  function a (a) {
    function b (a) {
      for (var b = [16, 11, 10, 16, 24, 40, 51, 61, 12, 12, 14, 19, 26, 58, 60, 55, 14, 13, 16, 24, 40, 57, 69, 56, 14, 17, 22, 29, 51, 87, 80, 62, 18, 22, 37, 56, 68, 109, 103, 77, 24, 35, 55, 64, 81, 104, 113, 92, 49, 64, 78, 87, 103, 121, 120, 101, 72, 92, 95, 98, 112, 100, 103, 99], c = 0; c < 64; c++) {
        var d = y((b[c] * a + 50) / 100); d < 1 ? d = 1 : d > 255 && (d = 255), z[P[c]] = d
        ...
        var g = y((e[f] * a + 50) / 100); g < 1 ? g = 1 : g > 255 && (g = 255), A[P[f]] = g
      } for (var h = [1, 1.387039845, 1.306562965, 1.175875602, 1, 0.785694958, 0.5411961, 0.275899379], i = 0, j = 0; j < 8; j++) {
        for (var k = 0; k < 8; k++) {
  ...
  for (var b = a[0], c = a[1] - 1; c >= 0;) {
    b & 1 << c && (I |= 1 << J), c--, J--, J < 0 && (I == 255 ? (h(255), h(0)) : h(I), J = 7, I = 0)
  }
} function h (a) {
  H.push(N[a])
} function i (a) {
  ...
  var c, d, e, f, g, h, i, j, k, l = 0, m = 8, n = 64; for (k = 0; m > k; ++k) {
    c = a[l], d = a[l + 1], e = a[l + 2], f = a[l + 3], g = a[l + 4], h = a[l + 5], i = a[l + 6], j = a[l + 7]; var o = c + j, p = c - j, q = d + i, r = d - i, s = e + h, t = e - h, u = f + g, v = f - g, w = o + u, x = o - u, y = q + s, z = q - s; a[l] = w + y, a[l + 4] = w - y; var A = 0.707106781 * (z + x); a[l + 2] = x + A, a[l + 6] = x - A, w = v + t, y = t + r, z = r + p; var B = 0.382683433 * (w - z), C = 0.5411961 * w + B, D = 1.306562965 * z + B, E = 0.707106781 * y, G = p + E, H = p - E; a[l + 5] = H + C, a[l + 3] = H - C, a[l + 1] = G + D, a[l + 7] = G - D, l += 8
  } for (l = 0, k = 0; m > k; ++k) {
    c = a[l], d = a[l + 8], e = a[l + 16], f = a[l + 24], g = a[l + 32], h = a[l + 40], i = a[l + 48], j = a[l + 56]; var I = c + j, J = c - j, K = d + i, L = d - i, M = e + h, N = e - h, O = f + g, P = f - g, Q = I + O, R = I - O, S = K + M, T = K - M; a[l] = Q + S, a[l + 32] = Q - S; var U = 0.707106781 * (T + R); a[l + 16] = R + U, a[l + 48] = R - U, Q = P + N, S = N + L, T = L + J; var V = 0.382683433 * (Q - T), W = 0.5411961 * Q + V, X = 1.306562965 * T + V, Y = 0.707106781 * S, Z = J + Y, $ = J - Y; a[l + 40] = $ + W, a[l + 24] = $ - W, a[l + 8] = Z + X, a[l + 56] = Z - X, l++
  } var _; for (k = 0; n > k; ++k) {
  ...
  i(65499), i(132), h(0); for (var a = 0; a < 64; a++) {
     h(z[a])
   }h(1); for (var b = 0; b < 64; b++) {
    h(A[b])
  }
} function n () {
   i(65476), i(418), h(0); for (var a = 0; a < 16; a++) {
    h(Q[a + 1])
  } for (var b = 0; b <= 11; b++) {
    h(R[b])
  }h(16); for (var c = 0; c < 16; c++) {
    h(S[c + 1])
  } for (var d = 0; d <= 161; d++) {
    h(T[d])
  }h(1); for (var e = 0; e < 16; e++) {
    h(U[e + 1])
  } for (var f = 0; f <= 11; f++) {
  h(V[f])
}h(17); for (var g = 0; g < 16; g++) {
  h(W[g + 1])
} for (var j = 0; j <= 161; j++) {
  h(X[j])
}
  ...
  for (var f, h = e[0], i = e[240], k = 16, l = 63, m = 64, n = j(a, b), o = 0; m > o; ++o) {
    G[P[o]] = n[o]
  } var p = G[0] - c; c = G[0], p == 0 ? g(d[0]) : (f = 32767 + p, g(d[E[f]]), g(D[f])); for (var q = 63; q > 0 && G[q] == 0; q--) {
    ;
  } if (q == 0) {
    return g(h), c
  } for (var r, s = 1; q >= s;) {
    for (var t = s; G[s] == 0 && q >= s; ++s) {
       ;
     } var u = s - t; if (u >= k) {
    r = u >> 4; for (var v = 1; r >= v; ++v) {
      g(i)
    }u = 15 & u
  ...
  if (a <= 0 && (a = 1), a > 100 && (a = 100), x != a) {
    var c = 0; c = Math.floor(a < 50 ? 5e3 / a : 200 - 2 * a), b(c), x = a
  }
} function s () {
  a || (a = 50), q(), d(), e(), f(), r(a)
  ...
  b && r(b), H = new Array(), I = 0, J = 7, i(65496), k(), m(), l(a.width, a.height), n(), o(); var c = 0, d = 0, e = 0; I = 0, J = 7, this.encode.displayName = '_encode_'; for (var f, h, j, q, s, x, y, z, A, D = a.data, E = a.width, F = a.height, G = 4 * E, N = 0; F > N;) {
     for (f = 0; G > f;) {
      for (s = G * N + f, x = s, y = -1, z = 0, A = 0; A < 64; A++) {
  ...
  var d, e = a.canvasToDataUrl; a.canvasToDataUrl = function (a, f, g) {
    var h, i, j, k, l; return c.os.android ? (f === 'image/jpeg' && typeof d === 'undefined' && (k = e.apply(null, arguments), l = k.split(','), k = ~l[0].indexOf('base64') ? atob(l[1]) : decodeURIComponent(l[1]), k = k.substring(0, 2), d = k.charCodeAt(0) === 255 && k.charCodeAt(1) === 216), f !== 'image/jpeg' || d ? e.apply(null, arguments) : (i = a.width, j = a.height, h = a.getContext('2d'), b.encode(h.getImageData(0, 0, i, j), g))) : e.apply(null, arguments)
  }
}), b('runtime/html5/image', ['base', 'runtime/html5/runtime', 'runtime/html5/util'], function (a, b, c) {
  var d = 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D'; return b.register('Image', {modified: !1,
    init: function () {
      var a = this, b = new Image(); b.onload = function () {
        a._info = {type: a.type, width: this.width, height: this.height}, a._metas || a.type !== 'image/jpeg' ? a.owner.trigger('load') : c.parseMeta(a._blob, function (b, c) {
    ...
    loadFromBlob: function (a) {
      var b = this, d = b._img; b._blob = a, b.type = a.type, d.src = c.createObjectURL(a.getSource()), b.owner.once('load', function () {
        c.revokeObjectURL(d.src)
      })
    },
    resize: function (a, b) {
      var c = this._canvas || (this._canvas = document.createElement('canvas')); this._resize(this._img, c, a, b), this._blob = null, this.modified = !0, this.owner.trigger('complete')
    },
    getAsBlob: function (a) {
      var b, d = this._blob, e = this.options; if (a = a || this.type, this.modified || this.type !== a) {
        if (b = this._canvas, a === 'image/jpeg') {
    ...
    getAsDataUrl: function (a) {
      var b = this.options; return a = a || this.type, a === 'image/jpeg' ? c.canvasToDataUrl(this._canvas, a, b.quality) : this._canvas.toDataURL(a)
    },
    ...
    _rotate2Orientaion: function (a, b) {
      var c = a.width, d = a.height, e = a.getContext('2d'); switch (b) {
        case 5:case 6:case 7:case 8:a.width = d, a.height = c
      } switch (b) {
        case 2:e.translate(c, 0), e.scale(-1, 1); break; case 3:e.translate(c, d), e.rotate(Math.PI); break; case 4:e.translate(0, d), e.scale(1, -1); break; case 5:e.rotate(0.5 * Math.PI), e.scale(1, -1); break; case 6:e.rotate(0.5 * Math.PI), e.translate(0, -d); break; case 7:e.rotate(0.5 * Math.PI), e.translate(c, -d), e.scale(-1, 1); break; case 8:e.rotate(-0.5 * Math.PI), e.translate(-c, 0)
      }
    },
    _renderImageToCanvas: (function () {
      function b (a, b, c) {
        var d, e, f, g = document.createElement('canvas'), h = g.getContext('2d'), i = 0, j = c, k = c; for (g.width = 1, g.height = c, h.drawImage(a, 0, 0), d = h.getImageData(0, 0, 1, c).data; k > i;) {
          e = d[4 * (k - 1) + 3], e === 0 ? j = k : i = k, k = j + i >> 1
        } return f = k / c, f === 0 ? 1 : f
      } function c (a) {
        var b, c, d = a.naturalWidth, e = a.naturalHeight; return d * e > 1048576 ? (b = document.createElement('canvas'), b.width = b.height = 1, c = b.getContext('2d'), c.drawImage(a, -d + 1, 0), c.getImageData(0, 0, 1, 1).data[3] === 0) : !1
        ...
        var i, j, k, l, m, n, o, p = d.naturalWidth, q = d.naturalHeight, r = a.getContext('2d'), s = c(d), t = this.type === 'image/jpeg', u = 1024, v = 0, w = 0; for (s && (p /= 2, q /= 2), r.save(), i = document.createElement('canvas'), i.width = i.height = u, j = i.getContext('2d'), k = t ? b(d, p, q) : 1, l = Math.ceil(u * g / p), m = Math.ceil(u * h / q / k); q > v;) {
      for (n = 0, o = 0; p > n;) {
  ...
  var c = a.noop, d = a.$; return b.register('Transport', {init: function () {
    this._status = 0, this._response = null
  },
    send: function () {
      var b, c, e, f = this.owner, g = this.options, h = this._initAjax(), i = f._blob, j = g.server; g.sendAsBinary ? (j += (/\?/.test(j) ? '&' : '?') + d.param(f._formData), c = i.getSource()) : (b = new FormData(), d.each(f._formData, function (a, c) {
        b.append(a, c)
    ...
    _initAjax: function () {
      var a = this, b = new XMLHttpRequest(), d = this.options; return !d.withCredentials || 'withCredentials' in b || typeof XDomainRequest === 'undefined' || (b = new XDomainRequest()), b.upload.onprogress = function (b) {
        var c = 0; return b.lengthComputable && (c = b.loaded / b.total), a.trigger('progress', c)
      }, b.onreadystatechange = function () {
        return b.readyState === 4 ? (b.upload.onprogress = c, b.onreadystatechange = c, a._xhr = null, a._status = b.status, b.status >= 200 && b.status < 300 ? (a._response = b.responseText, a.trigger('load')) : b.status >= 500 && b.status < 600 ? (a._response = b.responseText, a.trigger('error', 'server')) : a.trigger('error', a._status ? 'http' : 'abort')) : void 0
      }, a._xhr = b, b
    },
  ...
  function e () {
    ...
    function d (a, b) {
      var c, d, e = a.type || a; c = e.split('::'), d = c[0], e = c[1], e === 'Ready' && d === j.uid ? j.trigger('ready') : f[d] && f[d].trigger(e.toLowerCase(), a, b)
  ...
  } var g = b.$, h = 'flash', i = {}; return b.inherits(c, {constructor: f,
    init: function () {
      var a, c = this.getContainer(), d = this.options; c.css({position: 'absolute', top: '-8px', left: '-8px', width: '9px', height: '9px', overflow: 'hidden'}), a = '<object id="' + this.uid + '" type="application/x-shockwave-flash" data="' + d.swf + '" ', b.browser.ie && (a += 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" '), a += 'width="100%" height="100%" style="outline:0"><param name="movie" value="' + d.swf + '" /><param name="flashvars" value="uid=' + this.uid + '&jsreciver=' + this.jsreciver + '" /><param name="wmode" value="transparent" /><param name="allowscriptaccess" value="always" /></object>', c.html(a)
    },
    getFlash: function () {
      ...
      return c = i[a] = b.inherits(d, g.extend({flashExec: function () {
        var a = this.owner, b = this.getRuntime(); return b.flashExec.apply(a, arguments)
      }}, c))
  ...
  var c = a.$; return b.register('FilePicker', {init: function (a) {
    var b, d, e = c.extend({}, a); for (b = e.accept && e.accept.length, d = 0; b > d; d++) {
  ...
  var d = a.$; return b.register('Transport', {init: function () {
    ...
    _initAjax: function () {
      var a = this, b = new c('XMLHttpRequest'); return b.on('uploadprogress progress', function (b) {
        return a.trigger('progress', b.loaded / b.total)
      }), b.on('load', function () {
        var c = b.exec('getStatus'), d = ''; return b.off(), a._xhr = null, c >= 200 && c < 300 ? (a._response = b.exec('getResponse'), a._responseJson = b.exec('getResponseAsJson')) : c >= 500 && c < 600 ? (a._response = b.exec('getResponse'), a._responseJson = b.exec('getResponseAsJson'), d = 'server') : d = 'http', b.destroy(), b = null, d ? a.trigger('error', d) : a.trigger('load')
      }), b.on('error', function () {
