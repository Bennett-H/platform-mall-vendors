  ...
  <el-dialog
    ...
    <el-form inline :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="消费达标金额" prop="money">
        <el-input-number v-model="dataForm.money" :disabled="disabled" controls-position="right" :min="0"
                         :max="99999999"
                         step-strictly></el-input-number>
      </el-form-item>
      <el-form-item label="折扣" prop="discount">
        <el-input v-model="dataForm.discount" :disabled="disabled" placeholder="折扣" class="width200"></el-input>
      </el-form-item>
      ...
      <el-form-item label="等级图片" prop="imageUrl">
        <el-tooltip content="建议像素50*50，大小不超过10KB">
